...
def check_location(board, bomb_board): 
    #Going to add more questions to the game, this is just an example! Will also add the timer
    ...
    while True:
        ...
        if bomb_board[row_input][col_input] == "*":
            ...
            for question in questions:
                print(question)
                counter()
                question_input = str(input("Answer this question for a redemption round, you have 5 seconds"))
